        ...
        <div class="leftside-navigation">
            <ul class="sidebar-menu" id="nav-accordion">
             ...
             <li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Awas vikas</span>
                    </a>
                    <ul class="sub">
            <li><a href="awasvikas.php">Add Lowns</a></li>
            <li><a href="glyphicon.php">Add Area</a></li>
                        <li><a href="grids.php">Add Details</a></li>
                    </ul>
                </li>
                <li>
            ...
            <li>
               ...
               <li class="sub-menu">
                    <a href="javascript:;">
                        <i class="fa fa-book"></i>
                        <span>Ghanta Ghar </span>
                    </a>
                    <ul class="sub">
            <li><a href="ghantaghar.php">Add Lowns</a></li>
            <li><a href="glyphicon.php">Add Area</a></li>
                        <li><a href="grids.php">Add Details</a></li>
                    </ul>
                </li>
            ...
            <li><a href="404.phpl">404 Error</a></li>
