...
<h1 class="text-center" style="font-weight: bold;font-style: italic;">avas vikas marriage lown</h1>

<div class="container-fluid">
	<a href="addawasvikas.php"><button style="background-color: brown;color:white;">Add lowns</button></a>
...
<table class="table" style="background-color: #660000;color: white;">
  ...
  <tr >
    ...
    <th style="color: white;"><img src="<?php echo '../avasvikas/image'.$row['image']?>" width = 50px height= 50px>
    </th>
