...
<!-- Mirrored from demo.w3layouts.com/demos_new/template_demo/30-04-2020/cutlery-libearty-demo_Free/492116884/web/landing-page.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 23 Feb 2021 16:05:39 GMT -->
...
<head>
    ...
    <title>cutlery a restaurant Category Responsive Web Template | Landing Page :: W3layouts</title>

    <!-- Template CSS -->
    <link rel="stylesheet" href="assets/css/style-libearty-demo.css">
...
<div class="bs-example bs-example-tabs right-sidebar-tab-notification" data-example-id="togglable-tabs">
    ...
    <div id="w3lDemoBar" class="w3l-demo-bar">
        <div class="demo-btns">
        <a href="https://w3layouts.com/?p=43449">
        ...
        <a href="https://w3layouts.com/checkout/?add-to-cart=43449" class="no-margin-bottom-mobile">
				...
				<div class="collapse navbar-collapse" id="navbarTogglerDemo02">
					<ul class="navbar-nav ml-auto">
						...
						<li class="nav-item @@services__active">
							<a class="nav-link" href="#services">Menu</a>
						</li>
						<li class="nav-item dropdown @@blog__active">
							...
							<div class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <a class="dropdown-item " href="#blog" class="drop-text">Blog</a>
                                <a class="dropdown-item " href="#team" class="drop-text">Team</a>
							</div>
						</li>
...
<!-- blog block -->
<section class="w3l-services-6" id="blog">
  <div class="services-layout ">
    ...
    <div class="blog-grids row">
      <div class="col-lg-4 col-md-6 col-sm-6 blog-grid" id="zoomIn">
          ...
          <p class="pos-date">March 19, 2020</p>
          <div class="blog-info">
              <h3><a href="blog-single.html">40 Truly Amazing Blueberry Recipes YUM!</a> </h3>
              <p class="para mt-3">Neque illo maiores assumenda alias nesciunt eaque inventore.</p>
          </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-6 mt-sm-0 mt-4 blog-grid" id="zoomIn">
          <a href="blog-single.html">
              <figure><img src="assets/images/b2.jpg" class="img-fluid" alt=""></figure>
          </a>
          <p class="pos-date">March 19, 2020</p>
          <div class="blog-info">
              <h3><a href="blog-single.html">24 Reasons To Seek Out Fresh Figs</a> </h3>
              <p class="para mt-3">Neque illo maiores assumenda alias nesciunt eaque inventore.</p>
          </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-6 mt-lg-0 mt-4 blog-grid" id="zoomIn">
          <a href="blog-single.html">
              <figure><img src="assets/images/b4.jpg" class="img-fluid" alt=""></figure>
          </a>
          <p class="pos-date">March 19, 2020</p>
          <div class="blog-info">
              <h3><a href="blog-single.html">Now You’re Cooking – Strawberry Granita</a> </h3>
              <p class="para mt-3">Neque illo maiores assumenda alias nesciunt eaque inventore.</p>
          </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-6 mt-lg-5 mt-4 blog-grid" id="zoomIn">
          <a href="blog-single.html">
              <figure><img src="assets/images/b5.jpg" class="img-fluid" alt=""></figure>
          </a>
          <p class="pos-date">March 19, 2020</p>
          <div class="blog-info">
              <h3><a href="blog-single.html">The Basil Recipes That Define Summer</a> </h3>
              <p class="para mt-3">Neque illo maiores assumenda alias nesciunt eaque inventore.</p>
          </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-6 mt-lg-5 mt-4 blog-grid" id="zoomIn">
          ...
          <p class="pos-date">March 19, 2020</p>
          <div class="blog-info">
              <h3><a href="blog-single.html">Helping you and your house become better acquainted.</a> </h3>
              <p class="para mt-3">Neque illo maiores assumenda alias nesciunt eaque inventore.</p>
          </div>
      </div>
      <div class="col-lg-4 col-md-6 col-sm-6 mt-lg-5 mt-4 blog-grid" id="zoomIn">
          ...
          <p class="pos-date">March 19, 2020</p>
          <div class="blog-info">
              <h3><a href="blog-single.html">14 Clever Cooking Hacks You Need to Try</a> </h3>
              <p class="para mt-3">Neque illo maiores assumenda alias nesciunt eaque inventore.</p>
          </div>
      </div>
  </div>
