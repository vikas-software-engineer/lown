...
if(isset($_POST['submit'])){
  ...
  move_uploaded_file($_FILES['image']['tmp_name'],'../ghantaghar/image'.$img);
  $ratting = $_POST['ratting'];
  $des = $_POST['des'];



  $sql = "insert into ghantaghar (image,ratting,des) VALUES ('$img','$ratting','$des')";
 mysqli_query($con,$sql);
header('location:ghantaghar.php');
die();
}
